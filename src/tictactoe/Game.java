...
//                if ("EXIT".equals(command[0])) {
//                    System.exit(0);
//                } else if ("START".equals(command[0]) && "EASY".equals(command[1]) && "EASY".equals(command[2])) {
//                    playerX = new EasyAI(game, BoardValue.X.getValue());
//                    playerY = new EasyAI(game, BoardValue.O.getValue());
//                    this.setWhoPlayerX(1);
//                    this.setWhoPlayerY(1);
//                    break;
//                } else if ("START".equals(command[0]) && "USER".equals(command[1]) && "EASY".equals(command[2])) {
//                    playerX = new Human(game, BoardValue.X.getValue());
//                    playerY = new EasyAI(game, BoardValue.O.getValue());
//                    this.setWhoPlayerX(0);
//                    this.setWhoPlayerY(1);
//                    break;
//                } else if ("START".equals(command[0]) && "USER".equals(command[1]) && "USER".equals(command[2])) {
//                    playerX = new Human(game, BoardValue.X.getValue());
//                    playerY = new Human(game, BoardValue.O.getValue());
//                    this.setWhoPlayerX(0);
//                    this.setWhoPlayerY(0);
//                    break;
//                } else {
//                    System.out.println("Bad parameters!");
//                }
//            } catch (IllegalArgumentException | NoSuchElementException | ArrayIndexOutOfBoundsException exceptions) {
//                System.out.println("Bad parameters!");
//            }
//        }
...
//    // 0 means a human player, 1 means an easyAI player, 2 means a mediumAI player
//    void setWhoPlays(int intPlayer, Player player) {
//        if (intPlayer == 0) {
//            player.move();
//        } else if (intPlayer == 1) {
//            player.move();
